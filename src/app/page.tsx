...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center text-gray-900 overflow-x-hidden overflow-y-auto" style={{position: 'relative'}}>
      ...
      >
        <h1
          className={`text-4xl sm:text-6xl mb-4 tracking-tight animate-bounce ${bungee.className} whitespace-pre-line w-full text-balance break-keep`}
          style={{
        ...
        >
          <AnimatedText text={"Pogotowie\u00A0informatyczne\n24/7 – zadzwoń teraz"} />
        </h1>
      ...
      >
        <div className="max-w-5xl w-full mx-auto">
          ...
          >
            <AnimatedText text={"Zakres\u00A0usług".replace(' ', '\n')} />
          </h2>
      ...
      >
        ...
        >
          <AnimatedText text={"Dlaczego warto wybrać\nnas?"} />
        </h2>
